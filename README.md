...
Créer **Quantum Factory Tycoon 1.0 - Singularity Edition**, une version avancée mais contenue dans un seul fichier HTML, avec un code ultra-commenté (minimum 80% de commentaires) pour faciliter la maintenance, l'évolution et l'innovation.
Objectifs clés :
...
## 🎯 **Objectif Principal** (Version Développée)
...
### **3 Piliers du Fun**
1. **Satisfaction Visuelle** : Particules quantiques, connexions animées, néons sci-fi, mutations mystiques
2. **Progression Dopaminergique** : XP ding → grille + → nouvelles machines → "juste une partie de plus"
3. **Défis Intellectuels** : Optimisation (pollution/énergie), mystères (anomalies), IA rivale intelligente
### **Identité Unique** 
...
## 🎯 **Objectif Principal** (Vision 2 Ans - 2026-2028)
...
#### **Phase 1 : Prototype → Viral (6 mois)**
```
...
#### **Phase 2 : Steam Early Access (12 mois)**
```
...
### **💎 Proposition de Valeur Unique (24 mois)**
```
...
### **🔧 Contraintes Techniques Évolutives**
```
...
- **Modularité** : Sections JS claires (`// === SECTION: Grid ===`).  
- **Perf** : Data-driven (JSON machines), Web Workers pour simu.  
...
## ⚙️ **Core Loop Évolué : "Quantum Singularity Cycle"**
...
### **🌀 NOUVEAU CORE LOOP : 4 COUCHES ADAPTATIVES**
...
### **✨ INNOVATIONS LOOP RÉVOLUTIONNAIRES**

#### **1. ENTROPIE AUTO-RÉGULATRICE**
```
...
#### **3. PARADOXES RISQUÉS/RÉCOMPENSÉS**
```
...
#### **4. SINGULARITY HORIZON (Prestige 5+)**
```
...
### **🎯 NOUVELLE FORMULE DE PROGRESSION**
```
XP = (ProdTotal + $Vendus + EntropieGérée + ParadoxesRésolus) × StyleBonus
...
### **✨ RÉSULTAT : LOOP INFINIMENT REJOUABLE**
...
## 📈 **Progression par Ères** (Nouvelle structure !)
...
## 🏭 **Machines Data-Driven** (JSON exemple)
```json
[
...
## 🎮 **Fonctionnalités Clés** (Priorisées V1 → Late)
### V1 Core (Niv 1–25)
...
## 🛸 **LAYER ULTIME MOBILE : "Quantum Ghost"**
...
### **📱 Structure Layer (CSS Grid + Canvas)**
...
### **🎨 CODE CSS COMPLET MOBILE**

```css
/* RESET MOBILE + QUANTUM GHOST */
...
.machine-bubble.show { opacity: 1; transform: translate(-50%, -100%); }
```

### **✨ RÉSULTAT FINAL (95% IMMERSION)**
```
SCREEN 100% = GRILLE + PARTICULES
...
**Quantum Ghost =** *L'UI mobile la plus pure jamais vue pour tycoon. Zéro friction, 100% immersion.* [pixune](https://pixune.com/blog/best-examples-mobile-game-ui-design/)

**Implémenter ?** Code JS gestures + Canvas grid ?

## 💻 **LAYER ULTIME PC : "Nebula Command Center"**
...
### **🖥️ Structure Layer (CSS Grid + WebGL)**
...
### **🌌 6 ORBITES DE COMMANDES** (Détails riches, transparent)
...
### **🎮 CONTEXT MENU RADIAL** (Clic droit)
...
### **✨ RÉSULTAT FINAL PC (92% IMMERSION)**
...
## 🚀 **Innovations Uniques Ajoutées**
1. **IA Évolutive** : Niv.30+ , apprend patterns, suggère "builds perso".  
2. **Mystique RNG** : Événements "Anomalie Quantique" → mutations machines.  
3. **Bac à Sable Procédural** : Génère maps challenges infinis.  
4. **Export/Import** : JSON usines pour share Discord/Reddit.  
5. **STEM Mode** : Explique physique réelle (ex: Bose-Einstein).  
6. **AR Overlay** : Scan table → usine 3D réelle (mobile).  
7. **Speedrun Leaderboards** : Local + cloud-simulé. 

## 📋 **Machines Exemples** (Sélection par ère)
### T1 Base
...
# 🚀 PROMPT ULTIME : Quantum Factory Tycoon 7.0 - GÉNÉRATEUR COMPLET

## 🎯 MISSION ABSOLUE
Générer le **CODE COMPLET (1 fichier HTML)** de **Quantum Factory Tycoon 7.0 - Singularity Edition** basé EXACTEMENT sur ce GDD. 
**CONTRAINTES :** 1 fichier HTML uniquement, ≥85% commenté, 60FPS garanti, mobile/PC, vanilla JS/CSS.

## 📋 SPÉCIFICATIONS TECHNIQUES OBLIGATOIRES

### STRUCTURE FICHIER (À RESPECTER):
```html
<!DOCTYPE html>
<html>
<head>
...
- **60 FPS** : requestAnimationFrame + deltaTime
- **Mémoire** : < 100MB peak (150 machines max)
- **Mobile** : 30+ FPS iPhone 12, gestures natifs
- **PWA** : offline-first, installable

## 🎮 CORE LOOP IMPLEMENTATION (Quantum Singularity Cycle)

### RESSOURCES (9 totales) - JSON exact :
```json
const RESOURCES = {
...
### MACHINES V1 (25 MINIMUM) - Data-driven :
```javascript
const MACHINES = [
...
## 🖼️ RENDERING SYSTEM (Canvas 2D/WebGL)
...
### 3 SYSTÈMES UI (Selon device)

#### MOBILE "QUANTUM GHOST" (95% grille visible)
```
...
### ENTROPIE MÉCANIQUE (Innovation clé)
```javascript
...
## 💾 SAVE/LOAD SYSTEM (localStorage + Export)
```javascript
...
## 🎨 VISUELS QUANTIQUES (Canvas particles)
...
```javascript
// 5 sons : place, upgrade, sell, paradox, singularity
